...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        animator2_X.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_X.setRepeatMode(ObjectAnimator.REVERSE);
        animator2_Y.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_Y.setRepeatMode(ObjectAnimator.REVERSE);
        animatorSet2.play(animator2_X).with(animator2_Y);
        animatorSet2.setDuration(Integer.parseInt(durationSelector.getText().toString()));
//        animatorSet2.start();
...
//        animatorSet2.start();
        ...
        animatorSet.playTogether(animator1,animatorSet2,animator3);
        animatorSet.start();
    }
}
